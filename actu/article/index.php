...
include('../../includes/config.php');
    if(isset($_SESSION['id'])) {
        ...
        include('../../includes/include-article.php');
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container mt-4" style="margin-bottom: 80px;">
            <div class="row">
                <div class="col-md-8 mb-3">
                    <div class="card">
                        <img src="../../assets/uploads/articles/<?php echo $miniature ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Publié le : <?php echo date("d/m/Y", strtotime($date_article)); ?></li>
                            <li class="list-group-item">Par : <?php echo $author ?></li>
                        </ul>
                    </div>
                </div>
            </div>
