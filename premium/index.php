        ...
        <div class="container mt-4">
            <div class="row">
                <div class="col-md-8 mb-3">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Devenir Premium</h5>
                            <h6 class="card-subtitle mb-2 text-muted">Description</h6>
                            <p class="card-text">Devenez membre Premium et accéder à de nombreux avantages pour un prix tout à fait attractif</p>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Participation aux tournois</li>
                                <li class="list-group-item">Accès aux maps</li>
                                <li class="list-group-item">Livraison prioritaire</li>
                                <li class="list-group-item">VioumCoins multiplé par 2</li>
                                <li class="list-group-item">Grade spécial</li>
                                <li class="list-group-item">Photo de profil GIF</li>
                            </ul>
                            <h5 class="float-left mt-3">5€/mois</h5>
                            <a href="#" class="btn btn-primary float-right mt-2">Souscrire</a>
                        </div>
                    </div>
                </div>
