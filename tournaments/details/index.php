...
$name = $name->fetch();
include('../../includes/include-tournaments.php');
        ...
        <div class="container mt-4" style="margin-bottom: 80px;">
            <div class="row">
                <div class="col-md-8 mb-3">
                    <div class="card">
                        <img src="../../assets/uploads/tournaments/<?php echo $miniature ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $namet; ?></h5>
                ...
                <div class="col-md-4">
                    <div class="card mb-3">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Publié le : <?php echo date("d/m/Y", strtotime($date_publish)); ?></li>
                            <li class="list-group-item">Organisateur : <?php echo $author ?></li>
                            <li class="list-group-item">Date du tournoi : <?php echo date("d/m/Y". " à " ."H:m", strtotime($date_tournament)); ?></li>
                            <li class="list-group-item">Participants : 0/<?php echo $participants ?></li>
                            <li class="list-group-item">Mode : <?php echo $mode ?></li>
                            <li class="list-group-item">Cashprice : <?php echo $cashprice ?></li>
                        </ul>
                    </div>
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-primary btn-lg btn-block">Participer</button>
                        </div>
                    </div>
                </div>
