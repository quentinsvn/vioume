...
include('../../includes/include-product.php');
        ...
        <div class="container mt-4" style="margin-bottom: 80px;">
            <div class="row">
                <div class="col-md-8 mb-3">
                    <div class="card">
                        <img src="../../assets/uploads/products/<?php echo $miniature ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $namep; ?></h5>
                ...
                <div class="col-md-4">
                    <div class="card mb-3">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Prix : <b><?php echo $price ?> Vioucoins</b></li>
                        </ul>
                    </div>
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            <button class="btn btn-primary btn-lg btn-block">Commander</button>
                        </div>
                    </div>
                </div>
            </div>
